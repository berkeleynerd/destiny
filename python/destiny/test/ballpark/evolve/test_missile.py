...
class TestMissile(helpers.BallparkTestCase):
    ...
    def test_not_aimed_not_massive_from_stationary(self):
        ...
        self.assertAlmostEqual(self.missile.vx, 0.0)
        self.assertAlmostEqual(self.missile.vy, 0.0)
        self.assertAlmostEqual(self.missile.vz, -150)

        for i in range(20):
            self.park.Evolve()

        # After launch, they aim for their destination, ignoring the intruder
        self.assertAlmostEqual(self.missile.vx, self.missile.maxVelocity * self.missile.speedFraction, places=2)
        self.assertAlmostEqual(self.missile.vy, 0.0, delta=0.5)
        self.assertAlmostEqual(self.missile.vz, 0.0, delta=0.5)

        # The intruder should not have moved
        self.assertAlmostEqual(self.collider.x, 2e3)
        self.assertAlmostEqual(self.collider.y, 0.0)
        self.assertAlmostEqual(self.collider.z, 0.0)
    ...
    def test_not_aimed_not_massive_from_moving(self):
        ...
        self.assertAlmostEqual(self.missile.vx, 0.0)
        self.assertAlmostEqual(self.missile.vy, 0.0)
        self.assertAlmostEqual(self.missile.vz, 160)

        for i in range(20):
            self.park.Evolve()

        # After launch, they aim for their destination
        self.assertAlmostEqual(self.missile.vx, self.missile.maxVelocity * self.missile.speedFraction, places=4)
        self.assertAlmostEqual(self.missile.vy, 0.0, places=0)
        self.assertAlmostEqual(self.missile.vz, 0.0, places=0)
    ...
    def test_aimed_not_massive(self):
        ...
        self.assertAlmostEqual(self.missile.vx, 1.0)
        self.assertAlmostEqual(self.missile.vy, 0.0)
        self.assertAlmostEqual(self.missile.vz, 0.0)
        ...
        self.assertAlmostEqual(self.missile.vx, self.missile.maxVelocity * self.missile.speedFraction, places=4)
        self.assertAlmostEqual(self.missile.vy, 0.0, places=4)
        self.assertAlmostEqual(self.missile.vz, 0.0, places=4)
