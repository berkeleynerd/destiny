...
class TestCapsuleCollision(helpers.BallparkTestCase):
    ...
    def test_collision_from_left(self):
        ...
        expected_coordinates = [
            ...
            (96.86492046470651, 100.0, 0.0),
            (96.68203132015965, 100.0, 0.0),
            (97.15348384835653, 100.0, 0.0),
            (97.15192345546411, 100.0, 0.0),
            (96.38417740736818, 100.0, 0.0),
            (95.97435909874342, 100.0, 0.0),
            (96.37634710556735, 100.0, 0.0),
            (96.97618134237088, 100.0, 0.0),
            (97.49222901445302, 100.0, 0.0),
            (97.43548158910887, 100.0, 0.0),
            (96.6620296302196, 100.0, 0.0),
            (96.25117441078329, 100.0, 0.0),
            (96.65221044990251, 100.0, 0.0),
            (97.25183572788421, 100.0, 0.0),
            (97.09165999965391, 100.0, 0.0),
            (96.30751435705749, 100.0, 0.0)
        ]
    ...
    def test_collision_from_right(self):
        ...
        expected_coordinates = [
            ...
            (202.441482876937, 100.0, 0.0),
            (202.7526311383029, 100.0, 0.0),
            (203.5523861689756, 100.0, 0.0),
            (203.96802133336672, 100.0, 0.0),
            (203.57137366900116, 100.0, 0.0),
            (203.51917037782508, 100.0, 0.0),
            (203.75257527190936, 100.0, 0.0)
        ]
        self.assertListOfPointsAlmostEqual(coordinates, expected_coordinates)
